...
const ELEVE_URL = adresseIp + "/user/findallEleve";
const DELETE_USER_URL = adresseIp + "/user/delete";

const Eleve = ({ navigation }) => {
            ...
            {data.map((eleve, index) => (
              <View style={styles.friendListItem} key={index}>
                <View style={styles.friendListItemLeft}>
                  <TouchableOpacity
                    style={styles.delete}
                    onPress={() => createTwoButtonAlert(eleve.id)}
                  >
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate("editUser",{
                      userId: eleve.id,
                      unom: eleve.nom,
                      uprenom: eleve.prenom,
                      uemail:eleve.email,
                      uphone: eleve.telephone,
                      upassword:eleve.password,
                      uecole: eleve.ecole
                    })}
                  >
